    ...
    <div class="row">
        <div class="col-md-4">
            <div class="panel panel-default panel-border-color panel-border-color-primary">
                <div class="panel-heading panel-heading-divider">Rechercher les classes</div>
                <div class="panel-body">
                    ...
                    <div class="row xs-pt-15">
                        <div class="col-xs-6 col-xs-offset-3">
                            <p class="text-center">
                                <button onclick="getClasse()" class="btn btn-space btn-primary">Rechercher</button>
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-md-8">
            <div class="panel panel-default panel-border-color panel-border-color-primary">
                <div class="panel-heading panel-heading-divider">Liste des classes<span class="panel-subtitle"></span></div>
                <div class="panel-body">
...
@section('custom_js')
    ...
    <script type="text/javascript">
        ...
        function getClasse(){
            $serie = $("#serie_id").val();
            if($serie != null){
                $.get("{{ route('classes.find') }}/"+$serie,function(data){
                    $("#data").html(data);
                });
            }else{
                $.gritter.add({
                    title: 'Erreur',
                    text: 'Veuillez selectionner une serie.',
